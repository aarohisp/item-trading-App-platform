      ...
      <div className="gx-app-login-wrap" style={{ marginTop: "40px" }}>
        <div className="gx-app-login-container">
          <div className="gx-app-login-main-content" style={{ textAlign: "end" }}>
            <div className="regindex-form-container" style={{ paddingTop: "300px", marginTop: "40px" }}>
              <h6 className={styles["signIn-description"]} style={{ fontSize: 40 }}>
                Registration Form
              </h6>
              {/* ... */}
              <Form {...formItemLayout} form={form} name="register" onFinish={onFinish} initialValues={{ residence: ["zhejiang", "hangzhou", "xihu"], prefix: "86" }} style={{ maxWidth: 700, marginLeft: 200 }} scrollToFirstError>
                <Form.Item
                  name="email"
                  label="E-mail"
                  rules={[
